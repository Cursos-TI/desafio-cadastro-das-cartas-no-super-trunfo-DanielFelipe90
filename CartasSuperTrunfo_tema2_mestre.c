...
int main(){
    ...
    printf("PIB per capita: %d\n", (float)(pib1 * 1e9) / populacao1 > (float)(pib2 * 1e9) / populacao2);
    printf("Super Poder: %d\n", (float) populacao1 + area1 + pib1 + pontosTuristicos1 + (float) (pib1 * 1e9) / populacao1 > (float)populacao2 + area2 + pib2 + pontosTuristicos2 + (float)(pib2 * 1e9) / populacao2);
